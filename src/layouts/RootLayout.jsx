  ...
  return (
    <div className="w-full mx-auto 2xl:container">
      ...
      <footer className="bg-black text-white">
        <div className="lg:p-12 p-8 d-none d-md-flex justify-content-between">
        ...
        <div className="d-md-none d-block px-3 py-8">
          <div className="d-flex mb-5 d-md-none gap-2 flex-column align-items-center justify-content-center">
          ...
          <div className="flex-wrap gap-16  d-flex ">
            <div className="grid grid-cols-2 gap-4">
              <div className="d-flex flex-column justify-content-start gap-2">
                ...
                <a
                  href="aboutus"
                  className=" font-family-2 font-light text-sm text-white no-underline"
                >
                  About Us
                </a>
                <a
              ...
              <div className="d-flex flex-column justify-content-start gap-2">
                ...
                <a
                  href="#"
                  className="font-family-2 font-light text-sm text-white no-underline disabled-link"
                >
                  Privacy policy
                </a>
                <a
