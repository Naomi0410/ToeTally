  ...
  return (
    <div className="py-2 font-family-2">
      <div className="py-8 md:py-12 font-family-2" ref={ref}>
        {/* Stats Section */}
        <div className="bg-gradient-to-r from-[#01497C] to-[#0369a1] text-white relative overflow-hidden">
          ...
          <div className="lg:hidden flex justify-center gap-2 pb-6 relative z-10">
            {stats.map((_, index) => (
              <div
                key={index}
      ...
      <div className="grid md:grid-cols-2 items-center md:pt-8 md:px-6 lg:px-12 mx-auto">
      ...
      <div className="flex flex-col justify-center items-center px-3 lg:w-11/12 mx-auto py-10 md:py-12">
        <h1 className="font-family-3 mx-auto mb-4 text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
          Meet The Team
        </h1>
