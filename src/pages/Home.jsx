    ...
    <main className="py-4">
      ...
      <section aria-labelledby="hero-heading">
        <div className="md:flex justify-center items-center">
          ...
          <Image
            src={heroImg}
            alt="Stylish comfortable footwear collection display"
      ...
      {/* Featured Product Section - Desktop */}
      <section
        aria-labelledby="featured-dunk-heading"
        className="hidden md:flex justify-center items-center gap-4 mt-14 md:px-3 lg:px-12"
      >
        <div className="md:w-3/5 xl:w-2/5">
          <img
            src={gif}
            className="w-full"
            alt="High Conic Dunk sneaker rotating display"
          />
        </div>
        <div className="flex flex-column gap-2 text-center items-center justify-between w-3/5">
          <Image src={discountBg} alt="" aria-hidden="true" />
          <h2
            id="featured-dunk-heading"
            className="font-family-4 text-2xl lg:text-4xl xl:text-5xl"
          >
            EXPERIENCE THE “HIGH” CONIC DUNK
          </h2>
          <p className="font-family-2 fw-bold text-3xl lg:text-[40px] xl:text-5xl">
            ICONIC FOR A REASON
          </p>
          ...
          <ActionButton
            ...
            aria-label="Shop High Conic Dunk collection"
      ...
      <section
        aria-labelledby="featured-dunk-heading-mobile"
        className="d-md-none d-block relative mt-12"
      >
        <img
          src={gif}
          alt="High Conic Dunk sneaker rotating display"
        ...
        <div className="d-flex flex-column align-items-center justify-content-center absolute top-0 left-1/2 -translate-x-1/2 text-center w-100 px-3">
          <Image src={discountBg} className="w-64" alt="" aria-hidden="true" />
          <h2
            id="featured-dunk-heading-mobile"
            className="font-family-4 text-xl"
          >
            EXPERIENCE THE “HIGH” CONIC DUNK
          </h2>
          <p className="font-family-2 fw-bold text-2xl">ICONIC FOR A REASON</p>
